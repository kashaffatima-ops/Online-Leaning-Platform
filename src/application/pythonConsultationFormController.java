...
public class pythonConsultationFormController {
    ...
    public void initialize() {
    	...
    	submit_bt.setOnAction(new EventHandler <ActionEvent>() {
    		@Override
    ...
    public void addConsultationForm(int sid,String sname,String date2,String time2,String topic) {
    	...
    	try {
		    ...
		    myRs=mystmt.executeQuery("Select instructor_id from courses where cname='Python'");
		    if (myRs.next()) {  
    	...
    	service.consultationReqSubmission(sid,sname,date2,time2,topic,instructorid,"Python");
    	return;
    }
}
