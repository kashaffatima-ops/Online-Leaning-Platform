...
public class cppMainHome {
    ...
    public void initialize() {
        ...
        public void handle(ActionEvent event) {
			try {
				FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("cppconsultationForm.fxml"));
		        Parent root = (Parent) fxmlLoader.load(); 
		        cppconsultationFormController ctrlrPointer = (cppconsultationFormController) fxmlLoader.getController();
		        Stage currentStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		        currentStage.close();
		        Scene scene = new Scene(root);
		        Stage stage=new Stage();
    ...
    Content_bt.setOnAction(new EventHandler<ActionEvent>() {
        ...
        public void handle(ActionEvent event) {
			try {
				FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("cppcourses.fxml"));
		        Parent root = (Parent) fxmlLoader.load(); 
		        CppCoursesController ctrlrPointer = (CppCoursesController) fxmlLoader.getController();
		        Stage currentStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		        currentStage.close();
		        Scene scene = new Scene(root);
		        Stage stage=new Stage();
