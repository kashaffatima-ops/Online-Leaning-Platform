...
public class JSconsultationFormController {
    ...
    public void addConsultationForm(int sid,String sname,String date2,String time2,String topic) {
    	...
    	try {
		    ...
		    myRs=mystmt.executeQuery("Select instructor_id from courses where cname='Js'");
		    if (myRs.next()) {  
    	...
    	service.consultationReqSubmission(sid,sname,date2,time2,topic,instructorid,"Java Script");
    	return;
    }
}
