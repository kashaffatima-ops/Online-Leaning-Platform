...
public class pythonMainHome {
    ...
    public void initialize() {
        ...
        public void handle(ActionEvent event) {
			try {
				FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("pythonConsultationForm.fxml"));
		        Parent root = (Parent) fxmlLoader.load(); 
		        pythonConsultationFormController ctrlrPointer = (pythonConsultationFormController) fxmlLoader.getController();
		        Stage currentStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		        currentStage.close();
		        Scene scene = new Scene(root);
		        Stage stage=new Stage();
    ...
    Content_bt.setOnAction(new EventHandler<ActionEvent>() {
        ...
        public void handle(ActionEvent event) {
			try {
				FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("pycourses.fxml"));
		        Parent root = (Parent) fxmlLoader.load(); 
		        PyCoursesController ctrlrPointer = (PyCoursesController) fxmlLoader.getController();
		        Stage currentStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		        currentStage.close();
		        Scene scene = new Scene(root);
		        Stage stage=new Stage();
    ...
    Payment_bt.setOnAction(new EventHandler<ActionEvent>() {
        ...
        public void handle(ActionEvent event) {
			try {
    	        ...
    	        ctrlrPointer.setSourcePage("Python");
    	        Stage currentStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
		        currentStage.close();
		        Scene scene = new Scene(root);
		        Stage stage=new Stage();
